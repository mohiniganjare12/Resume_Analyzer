  ...
  return (
    <div style={{ minHeight:'100vh', display:'flex', flexDirection:'column', fontFamily:"'Plus Jakarta Sans', sans-serif" }}>
      <style>{`
        ...
        .login-form-panel { width:100%; padding:28px 20px; background:#fff; display:flex; align-items:flex-start; justify-content:center }
        @media(min-width:1024px) {
          .login-wrap { flex-direction:row }
          .login-mobile-hero { display:none }
          .login-desktop-left { display:flex }
          .login-form-panel { max-width:500px; min-height:100vh; align-items:center; padding:40px 32px }
        }
      `}</style>
      ...
      <div className="login-wrap">
        ...
        {/* ── DESKTOP LEFT PANEL ── */}
        <div className="login-desktop-left" style={{
